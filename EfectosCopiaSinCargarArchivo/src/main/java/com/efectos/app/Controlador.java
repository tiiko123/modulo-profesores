...
public class Controlador implements Initializable {
        ...
        if (seleccion.equals("null")) {
            ...
            while (i <= this.matriz.size() / this.matriz.get(0).size()) {
                if (String.valueOf(this.matriz.get(i).get(0)).equals(seleccion)) {
                    ...
                    autorMTF.setText(this.matriz.get(i).get(2));
    ...
    public void modificar() throws IOException {
        ...
        XSSFSheet sheet = wb.getSheetAt(0);
            ...
            ponProf = Integer.parseInt(autorMTF.getText());
            ponDir = Integer.parseInt(cell3Update.getStringCellValue());
